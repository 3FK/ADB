            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form accept-charset="UTF-8" role="form" action="UpdateRover.php" method="post">
                            ...
                            <?php
                                    $get = oci_parse($conn,'SELECT ROVER_ID,Rover_Name FROM ROVER WHERE ROVER_ID = :rover');
                                    oci_bind_by_name($stmt,':rover',$rover);
                                    oci_execute($get);
                    ...
                    <form accept-charset="UTF-8" role="form" action="getinfoR.php" method="post">
                        <input class="btn btn-lg btn-danger btn-block" type="button" name="Get_record" value="Delete Rover Details" >
                    </form>
                </div>
            </div>
        </div>
