...
if(isset($_POST['insert_record'])) {
    ...
    $stmt = oci_parse($conn, 'INSERT INTO ROVER (ROVER_Name,Launched_Date,Launched_Time,Launched_From,Mass,Landed_Date,Landed_Time,Landed_to) VALUES(:Rover_Name,:Launched_Date,:Launched_Time,:Launched_From,:Mass,:Landed_Date,:Landed_Time,:Landed_To)');
